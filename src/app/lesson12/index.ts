...
import('src/assets/wasm/dip.wasm').then((data: Idip) => {
    ...
    const fpsNumDisplayElement: HTMLElement = <HTMLElement>document.querySelector(".fps-num");
    ...
    // the main process.
    let video: HTMLVideoElement = <HTMLVideoElement>document.querySelector(".video");
    let canvas: HTMLCanvasElement = <HTMLCanvasElement>document.querySelector(".canvas");

    // get a canvas context2D.
    let context2D: CanvasRenderingContext2D = <CanvasRenderingContext2D>canvas.getContext("2d");
